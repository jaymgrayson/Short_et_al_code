...
setwd("/Users/jasongrayson/Desktop/Critical Docs/Manuscripts/AML_Paper/JI_Version/JI_Paper_Project/Key_Data_Outputs/Figure_03")
load("~/Desktop/Critical Docs/Manuscripts/AML_Paper/JI_Version/JI_Paper_Project/Key_Data_Files/Figure_01/demo_data.RDa")
load("/Users/jasongrayson/Desktop/Critical Docs/Manuscripts/AML_Paper/Old_Version/Submissions/JI_Submission/Key_Dataframes/Various_versions/Figure_04/df.RDa")
...
CD8Cy_UMAP_all<-left_join(df,demo_data,by=c("MRN"))

set.seed(1234)
df2<-stratified(CD8Cy_UMAP_all,c("Relapse","Day_Rounded"), size=500)
...
g1<-g1+facet_grid(vars(Relapse))+ggtitle("CD8 Cytokines")
g1
...
save(CD8Cy_UMAP_all,file="CD8Cy_UMAP_all.RDa")
