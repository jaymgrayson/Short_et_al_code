...
load("~/Desktop/Critical Docs/Manuscripts/AML_Paper/JI_Version/JI_Paper_Project/Key_Data_Files/Figure_03/CD8Cy_UMAP_all.RDa")
df<-CD8Cy_UMAP_all
...
save(df_percentages,file="CD8_Cy_percentages_clusters.Rda")
