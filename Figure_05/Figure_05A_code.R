...
load("/Users/jasongrayson/Desktop/Critical Docs/Manuscripts/AML_Paper/JI_Version/JI_Paper_Project/Key_Data_Files/Figure_05/Good_Stuff_CD8R copy.RDa")
...
CD8Rel_UMAP_all<-left_join(df,demo_data_filtered,by=c("MRN"))
set.seed(1234)
df2<-stratified(CD8Rel_UMAP_all,c("Relapse","Stimulation"), size=500)
...
g1<-g1+facet_grid(vars(Relapse),vars(Stimulation))+ggtitle("CD8 Relapse")
g1
